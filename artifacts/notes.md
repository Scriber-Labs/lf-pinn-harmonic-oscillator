...
- [ ] is there a mathematical entity that relates to 
- [ ] ⚠️ I need a QUICK review derivaiton of this form (particullarly in terms of kinetic and potential energies). covectors the same way the cross product and the wedge product relate?
...
The matrix $$W = \begin{bmatrix} 0 & 1 \\ -1 & 0 \end{bmatrix}$$ is the matrix representation of $dq\wedge dp$.
In Clifford algebra language:
- $W$ is equivalent to multiplication by the phase-space pseudoscalar.
