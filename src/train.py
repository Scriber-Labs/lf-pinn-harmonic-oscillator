...
__all__: list[str] = ["main", "train", "make_collocation_points"]
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--hidden", type=int, default=64, help="number of hidden units per layer"
    )
...
def main(argv: list[str] | None = None) -> None:  # noqa: D401
    ...
    collocation = make_collocation_points(args.n_points, device=device, t_max=2 * np.pi)
